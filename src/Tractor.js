...
import TractorImage from "./Assets/Images/tractor_ametlles-768x460.jpg";  // Usa un alias aquí
  ...
  return (
    <div>
      ...
      <div className="image-container">
        <img src={TractorImage} alt="tractor" className="licor-image" />
      ...
      <div>
        <img src={TractorImage} alt="Licor" className="image-licor"/>
      </div>
